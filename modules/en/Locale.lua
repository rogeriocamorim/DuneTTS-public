return {
    ...
    notEnoughPersuasion = "{player} doesn't have enough persuasion! Need {cost}, has {persuasion}.",
    persuasionShortageNotice = "{player} is trying to acquire {card} which costs {cost} persuasion, but they only have {persuasion}.",
    confirmAcquireWithoutPersuasion = "You don't have enough persuasion to acquire {card} (costs {cost}, you have {persuasion}). Do you want to acquire it anyway?",
    playerAcquiredWithoutPersuasion = "{player} acquired {card} without enough persuasion.",
    playerDeclinedAcquisition = "{player} declined to acquire {card}.",
    ...
    endgameActiveInstruction = "Play any Endgame card and Tech tile you possess to gain final victory points.",
    ...
    armandEcazTrashReminder = "Reminder: You may trash one of your played cards (Armand Ecaz ability).",
    communityMode1 = "Community mode: Tier A +3 (B/C) then remove 2. (Max 7 leaders)",
    communityMode2 = "Community mode: Tier B + C then remove 11. (Max 7 leaders)",
    random = "Random",
    mode1 = "Mode 1 (Tier A + 3 from B/C) (7 max)",
    mode2 = "Mode 2 (7 from B + C)",
    ...
    glowglobesTooltip = "Glowglobes: Peek (search) the top card of your draw deck.",
    glowglobesUse = "{player} is using Glowglobes to peek the top card of their deck.",
    glowglobesUseSingle = "{player} is using Glowglobes. Only one card remains; use the standard peek command if needed.",
    ...
    bl_PivotalGambit = "Pivotal Gambit",
    ...
    need4Players = "Need 4 players to submit game",
    openConfirmationSubmit = "Submit Game",
    openSubmissionScreen = "Open submission screen",
    confirmed = "Confirm",
    waitingConfirmationScreen = "Waiting for player confirmations...",
    confirmedPlayersTitle = "Confirmed Players:",
    confirmationRecorded = "Your confirmation has been recorded.",
    confirmationAlreadyGiven = "You already confirmed.",
    submitInitiated = "%s (%s) initiated game submission request. Waiting for %d more player%s.",
    submitWaiting = "%s (%s) confirmed. Waiting for %d more player%s...",
    confirmationUnlocked = "Submission unlocked. Confirmed players:\n%s",
    confirmationRemaining = "%s (%s) confirmed. %d more confirmation%s needed.",
}
