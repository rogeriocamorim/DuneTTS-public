return {
    ...
    notEnoughPersuasion = "{player} n'a pas assez de persuasion ! Besoin de {cost}, a {persuasion}.",
    persuasionShortageNotice = "{player} essaie d'acquérir {card} qui coûte {cost} persuasion, mais n'en a que {persuasion}.",
    confirmAcquireWithoutPersuasion = "Vous n'avez pas assez de persuasion pour acquérir {card} (coûte {cost}, vous avez {persuasion}). Voulez-vous l'acquérir quand même ?",
    playerAcquiredWithoutPersuasion = "{player} a acquis {card} sans assez de persuasion.",
    playerDeclinedAcquisition = "{player} a refusé d'acquérir {card}.",
    ...
    endgameActiveInstruction = "Jouez vos cartes de fin de jeu et tuiles tech que vous possédez afin de gagner des PV finaux.",
    ...
    acquireTech = "■ Acquisition tech : « {tech} ».",
    ...
    armandEcazTrashReminder = "Rappel : Vous pouvez écarter une de vos cartes jouées (capacité d'Armand Ecaz).",
    ...
    glowglobesTooltip = "Glowglobes : Regardez la carte du dessus de votre pioche.",
    glowglobesUse = "{player} utilise les Glowglobes pour regarder la carte du dessus de sa pioche.",
    glowglobesUseSingle = "{player} utilise les Glowglobes. Il ne reste qu'une carte ; utilisez la commande normale si nécessaire.",
    ...
    communityMode1 = "Mode communauté: Tier A + 2 (B/C) puis retirer 2. (Max 7 leaders)",
    communityMode2 = "Mode communauté: Tiers B + C puis retirer 11. (Max 7 leaders)",
    random = "Aléatoire",
    mode1 = "Mode 1 (Tier A + 2 B/C)",
    mode2 = "Mode 2 (7 B/C)",
    ...
    need4Players = "Vous avez besoin de 4 joueurs pour soumettre la partie.",
    openConfirmationSubmit = "Ouvrir la confirmation de soumission",
    confirmed = "Confirmer",
    openSubmissionScreen = "Soumettre la partie",
    waitingConfirmationScreen = "En attente des confirmations des joueurs...",
    confirmedPlayersTitle = "Joueurs ayant confirmé :",
    confirmationRecorded = "Votre confirmation a été enregistrée.",
    confirmationAlreadyGiven = "Vous avez déjà confirmé.",
    submitInitiated = "%s (%s) a lancé une demande de soumission de jeu. En attente de %d joueur supplémentaire%s.",
    submitWaiting = "%s (%s) a confirmé. En attente de %d autre%s joueur%s...",
    confirmationUnlocked = "Soumission débloquée. Joueurs ayant confirmé :\n%s",
    confirmationRemaining = "%s (%s) a confirmé. Encore %d confirmation%s requise%s.",
}
