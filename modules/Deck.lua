...
---
function Deck.generateImperiumDeck(deckZone, contracts, ix, immortality, legacy, community)
    assert(deckZone)
    assert(deckZone.getPosition)
    local continuation = Helper.createContinuation("Deck.generateImperiumDeck")
    local contributions = Deck._mergeStandardContributionSets(Deck.imperium, ix, immortality, legacy, community)
    if contracts then
...
---
function Deck.generateIntrigueDeck(deckZone, contracts, ix, immortality, legacy, community)
    assert(deckZone)
    assert(deckZone.getPosition)
    local continuation = Helper.createContinuation("Deck.generateIntrigueDeck")
    local contributions = Deck._mergeStandardContributionSets(Deck.intrigue, ix, immortality, legacy, community)
    if contracts then
...
---
function Deck.generateLeaderDeck(deckZone, contracts, ix, immortality, legacy, community, free)
    assert(deckZone)
    assert(deckZone.getPosition)
    local continuation = Helper.createContinuation("Deck.generateLeaderDeck")
    local contributions = Deck._mergeStandardContributionSets(Deck.leaders, ix, immortality, legacy, community, free)
...
---
function Deck._mergeStandardContributionSets(root, ix, immortality, legacy, community, free)
    local contributionSets = { root.uprising }
    if community then
        table.insert(contributionSets, root.community)
    else
        if ix then
